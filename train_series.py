...
if __name__ == "__main__":
    ...
    trainer.train()
    """
    from train_pytorch.train3_aux_weight import Trainer
    print("start to train_pytorch: train3_aux_weight")
    trainer = Trainer(data_dir=data_dir, model_name="train3_aux_weight", epochs=10, batch_size=512, part=0.3, debug_mode=debug_mode)
    trainer.train()
    del trainer
    gc.collect()

    from train_pytorch.train4_aux_weight import Trainer
    print("start to train_pytorch: train4_aux_weight")
    trainer = Trainer(data_dir=data_dir, model_name="train4_aux_weight", epochs=10, batch_size=512, part=0.3, debug_mode=debug_mode)
    trainer.train()
    del trainer
    gc.collect()

    from train_pytorch.train5_aux_weight import Trainer
    print("start to train_pytorch: train5_aux_weight")
    trainer = Trainer(data_dir=data_dir, model_name="train5_aux_weight", epochs=10, batch_size=512, part=0.3, debug_mode=debug_mode)
    trainer.train()
    del trainer
    gc.collect()

    from train_pytorch.train6_aux_weight import Trainer
    print("start to train_pytorch: train6_aux_weight")
    trainer = Trainer(data_dir=data_dir, model_name="train6_aux_weight", epochs=10, batch_size=512, part=0.3, debug_mode=debug_mode)
    trainer.train()
    del trainer
    gc.collect()

    from train_pytorch.train7_aux_weight import Trainer
    print("start to train_pytorch: train7_aux_weight")
    trainer = Trainer(data_dir=data_dir, model_name="train7_aux_weight", epochs=10, batch_size=512, part=0.3, debug_mode=debug_mode)
    trainer.train()
    del trainer
    gc.collect()
    ...
    from train_pytorch.train9_aux_weight import Trainer
    print("start to train_pytorch: train9_aux_weight")
    trainer = Trainer(data_dir=data_dir, model_name="train9_aux_weight", epochs=10, batch_size=512, part=0.3, debug_mode=debug_mode)
    trainer.train()
    del trainer
    gc.collect()

    from train_pytorch.train10_aux_weight import Trainer
    print("start to train_pytorch: train10_aux_weight")
    trainer = Trainer(data_dir=data_dir, model_name="train10_aux_weight", epochs=10, batch_size=512, part=0.3, debug_mode=debug_mode)
    trainer.train()
    del trainer
    gc.collect()

    from train_pytorch.train11_aux_weight import Trainer
    print("start to train_pytorch: train11_aux_weight")
    trainer = Trainer(data_dir=data_dir, model_name="train11_aux_weight", epochs=10, batch_size=512, part=0.3, debug_mode=debug_mode)
    trainer.train()
    del trainer
    gc.collect()

    from train_pytorch.train12_aux_weight import Trainer
    print("start to train_pytorch: train12_aux_weight")
    trainer = Trainer(data_dir=data_dir, model_name="train12_aux_weight", epochs=10, batch_size=512, part=0.3, debug_mode=debug_mode)
    trainer.train()
    del trainer
    gc.collect()

    from train_pytorch.train13_aux_weight import Trainer
    print("start to train_pytorch: train13_aux_weight")
    trainer = Trainer(data_dir=data_dir, model_name="train13_aux_weight", epochs=10, batch_size=512, part=0.3, debug_mode=debug_mode)
    trainer.train()
    del trainer
    gc.collect()

    from train_pytorch.train14_aux_weight import Trainer
    print("start to train_pytorch: train14_aux_weight")
    trainer = Trainer(data_dir=data_dir, model_name="train14_aux_weight", epochs=10, batch_size=512, part=0.3, debug_mode=debug_mode)
    trainer.train()
    del trainer
    gc.collect()
    ...
    from train_pytorch.train15_aux_weight import Trainer
    print("start to train_pytorch: train15_aux_weight")
    trainer = Trainer(data_dir=data_dir, model_name="train15_aux_weight", epochs=10, batch_size=512, part=0.3, debug_mode=debug_mode)
    trainer.train()
    del trainer
    gc.collect()

    from train_pytorch.train16_aux_weight import Trainer
    print("start to train_pytorch: train16_aux_weight")
    trainer = Trainer(data_dir=data_dir, model_name="train16_aux_weight", epochs=10, batch_size=512, part=0.3, debug_mode=debug_mode)
    trainer.train()
    del trainer
    gc.collect()

    from train_pytorch.train17_aux_weight import Trainer
    print("start to train_pytorch: train17_aux_weight")
    trainer = Trainer(data_dir=data_dir, model_name="train17_aux_weight", epochs=10, batch_size=512, part=0.3, debug_mode=debug_mode)
    trainer.train()
    del trainer
    gc.collect()

    from train_pytorch.train18_aux_weight import Trainer
    print("start to train_pytorch: train18_aux_weight")
    trainer = Trainer(data_dir=data_dir, model_name="train18_aux_weight", epochs=10, batch_size=512, part=0.3, debug_mode=debug_mode)
    trainer.train()
    del trainer
    gc.collect()
