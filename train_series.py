...
if __name__ == "__main__":
    ...
    trainer.train()
    """
    from train_pytorch.train3_aux_identity import Trainer
    print("start to train_pytorch: train3_aux_identity")
    trainer = Trainer(data_dir=data_dir, model_name="train3_aux_identity", epochs=10, batch_size=512, part=0.3, debug_mode=debug_mode)
    trainer.train()
    del trainer
    gc.collect()
