...
class Trainer:
    ...
    def process_sample(self, sample, table_dict, bert_tokenizer):
        ...
        return tag_masks, sel_masks, con_masks, type_masks, attention_masks, connection_labels, agg_labels, tag_labels, con_num_labels, type_labels, cls_index_list, conc_tokens, header_question_list, header_table_id_list
    ...
    def train(self):
        ...
        for epoch in range(self.epochs):
            ...
            print(eval_result)
            f_log.write("epoch: %d duration: %d min \n" % (epoch + 1, int((time.time() - train_start_time) / 60)))
