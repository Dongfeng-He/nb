...
class Trainer:
    ...
    def custom_loss(self, y_pred, y_batch, epoch, target_weight=1., aux_weight=1., identity_weight=1., np_weight=1.):
        ...
        if epoch > 9:
            ...
            aux_loss = nn.BCEWithLogitsLoss(reduction="mean")(aux_pred, aux_true)
    ...
    def train(self):
        ...
        for epoch in range(self.epochs):
            ...
            for i, batch_data in enumerate(train_loader):
                ...
                loss = target_loss * 0.5 + aux_loss * 0.5
                ...
                if (i + 1) % valid_every == 0:
                    ...
                    if not self.debug_mode:
                        ...
                        model_name = model_name = "model2/model_%s_%d_%d_%d_%dmin_%dmin_%.4f.bin" % (self.model_name, self.seed, epoch + 1, stage, train_duration, valid_duration, auc_score)
