...
class BertNeuralNet(BertPreTrainedModel):
    def __init__(self, config):
        ...
        # 输出层
        self.linear_out = nn.Linear(dense_size * 3, 1)
        self.linear_aux_out = nn.Linear(dense_size * 3, 5)
        self.linear_identity_out = nn.Linear(dense_size * 3, 9)
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None, labels=None):
        ...
        identity_result = self.linear_identity_out(h_conc)
